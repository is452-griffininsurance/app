                ...
                <Col style={{ width: '33.5%', textAlign: 'center' }}>
                  <Card style={iconCardStyle} hoverable='true'>
                    <Meta
                      ...
                      title={<Title level={3}>{this.state.numTransactionData}</Title>}
                    />
                  </Card>
                </Col>
                <Col style={{ width: '33.5%', textAlign: 'center' }}>
                  <Card style={iconCardStyle} hoverable='true' >
                    <Meta
                      ...
                      title={<Title level={3}>{this.state.numInsuredData}</Title>}
                ...
                <Col style={{ width: '33%', textAlign: 'center' }}>
                  <Card style={iconCardStyle} hoverable='true'>
                    <Meta
                      ...
                      title={<Title level={3}>{this.state.numInsuringData}</Title>}
